import uuid
import unittest
from main import Book, add_book, delete_book, search_books, display_books, change_status, load_books_from_file, \
    save_books_to_file
...
class TestLibraryManagementSystem(unittest.TestCase):
    ...
    def test_add_book(self):
        add_book("New Book", "New Author", "2024")
